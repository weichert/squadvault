...
echo "=== Patch: repair broken allowlist patchers (bare split-quote newline) (v3) ==="
...
${PY} -m py_compile scripts/_patch_repair_broken_allowlist_patchers_newline_in_quote_v3.py
${PY} scripts/_patch_repair_broken_allowlist_patchers_newline_in_quote_v3.py
