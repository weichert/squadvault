...
WRAPPER = "scripts/patch_cleanup_obsolete_ci_guardrails_ops_entrypoint_parity_iterations_v1.sh"
MARKER = "# SV_ALLOWLIST: cleanup_ci_guardrails_ops_entrypoint_parity_iterations (v1)"
...
def main() -> None:
    ...
    if MARKER in text:
        if WRAPPER in text:
            print("OK: wrapper already allowlisted (cleanup v1)")
            return
