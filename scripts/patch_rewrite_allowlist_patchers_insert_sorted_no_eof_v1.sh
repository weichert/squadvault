...
echo "=== Patch: rewrite allowlist patchers to insert-sorted (NO EOF strings) (v1) ==="
...
${PY} scripts/_patch_rewrite_allowlist_patchers_insert_sorted_no_eof_v1.py
