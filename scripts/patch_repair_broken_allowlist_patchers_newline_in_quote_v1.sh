...
echo "=== Patch: repair broken allowlist patchers (newline-in-quote) (v1) ==="
...
${PY} -m py_compile scripts/_patch_repair_broken_allowlist_patchers_newline_in_quote_v1.py
${PY} scripts/_patch_repair_broken_allowlist_patchers_newline_in_quote_v1.py
