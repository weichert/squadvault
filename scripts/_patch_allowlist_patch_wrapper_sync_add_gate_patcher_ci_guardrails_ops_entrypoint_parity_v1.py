...
WRAPPER = "scripts/patch_sync_add_gate_patcher_ci_guardrails_ops_entrypoint_parity_v1.sh"
MARKER = "# SV_ALLOWLIST: sync_add_gate_patcher_ci_guardrails_ops_entrypoint_parity (v1)"
...
def main() -> None:
    ...
    if MARKER in text:
        if WRAPPER in text:
            print("OK: wrapper already allowlisted (sync v1)")
            return
