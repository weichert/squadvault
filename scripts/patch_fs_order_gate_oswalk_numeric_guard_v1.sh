...
echo "=== Patch: fs ordering gate os.walk numeric guard (v1) ==="

allowed_paths=(
  "scripts/_patch_fs_order_gate_oswalk_numeric_guard_v1.py"
  "scripts/patch_fs_order_gate_oswalk_numeric_guard_v1.sh"
...
"$python_bin" scripts/_patch_fs_order_gate_oswalk_numeric_guard_v1.py

echo "==> bash -n target"
bash -n scripts/check_filesystem_ordering_determinism.sh

echo "==> py_compile patcher"
"$python_bin" -m py_compile scripts/_patch_fs_order_gate_oswalk_numeric_guard_v1.py
