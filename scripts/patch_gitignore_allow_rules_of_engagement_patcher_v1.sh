#!/usr/bin/env bash
set -euo pipefail
echo "=== Patch: allow tracking rules-of-engagement patcher (v1) ==="
...
PATCHER="scripts/_patch_rules_of_engagement_add_docs_mutation_policy_v1.py"
UNIGNORE="!${PATCHER}"
...
git commit -m "Ops: allowlist rules-of-engagement patcher (v1)" || {
