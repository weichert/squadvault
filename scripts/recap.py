...
def build_parser() -> argparse.ArgumentParser:
    ...
    sp.add_argument("--season", type=int, required=True)
    sp.add_argument("--team-a-id", type=str, required=True)
    sp.add_argument("--team-b-id", type=str, required=True)
