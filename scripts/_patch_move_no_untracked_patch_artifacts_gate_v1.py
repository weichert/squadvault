...
ECHO_LINE = 'echo "=== Gate: no untracked patch artifacts (v1) ==="\n'
CALL_LINE = "bash scripts/gate_no_untracked_patch_artifacts_v1.sh\n"

ANCHOR = "bash scripts/gate_no_test_dir_case_drift_v1.sh"
...
def main() -> int:
    ...
    if block_start is None:
        print("ERROR: refused to patch (could not find no-untracked-patch-artifacts gate block).", file=sys.stderr)
    ...
    # Find anchor in new_lines and insert after it
    anchor_idx = None
