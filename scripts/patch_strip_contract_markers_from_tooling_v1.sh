...
echo "=== Patch: strip SV_CONTRACT markers from tooling scripts (v1) ==="
...
"${PY}" scripts/_patch_strip_contract_markers_from_tooling_v1.py

# hygiene
python -m py_compile scripts/_patch_strip_contract_markers_from_tooling_v1.py
