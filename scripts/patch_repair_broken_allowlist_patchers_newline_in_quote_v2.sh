...
echo "=== Patch: repair broken allowlist patchers (split-quote newline) (v2) ==="
...
${PY} -m py_compile scripts/_patch_repair_broken_allowlist_patchers_newline_in_quote_v2.py
${PY} scripts/_patch_repair_broken_allowlist_patchers_newline_in_quote_v2.py
