...
# --- Shell checks (narrow) ---
safe_grep -I --exclude-dir=__pycache__ --exclude=*.pyc shell_hits_ls_while grep -R -n -E '(^|[[:space:];&(])ls([[:space:]].*)?[[:space:]]*\|[[:space:]]*while[[:space:]]+read' scripts
safe_grep -I --exclude-dir=__pycache__ --exclude=*.pyc shell_hits_ls_xargs grep -R -n -E '(^|[[:space:];&(])ls([[:space:]].*)?[[:space:]]*\|[[:space:]]*xargs' scripts
safe_grep -I --exclude-dir=__pycache__ --exclude=*.pyc shell_hits_find_while grep -R -n -E 'find[[:space:]].*\|[[:space:]]*while[[:space:]]+read' scripts
...
# --- Python checks ---
safe_grep -I --exclude-dir=__pycache__ --exclude=*.pyc py_hits_listdir grep -R -n -E 'os\.listdir[[:space:]]*\(' src scripts
safe_grep -I --exclude-dir=__pycache__ --exclude=*.pyc py_hits_globglob grep -R -n -E 'glob\.glob[[:space:]]*\(' src scripts
...
safe_grep -I --exclude-dir=__pycache__ --exclude=*.pyc py_hits_pathglob grep -R -n -E '\.r?glob[[:space:]]*\(' src scripts
...
safe_grep -I --exclude-dir=__pycache__ --exclude=*.pyc py_hits_oswalk_raw grep -R -n -E 'os\.walk[[:space:]]*\(' src scripts
