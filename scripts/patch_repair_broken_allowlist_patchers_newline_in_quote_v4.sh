...
echo "=== Patch: repair broken allowlist patchers (split f-string newline) (v4) ==="
...
${PY} -m py_compile scripts/_patch_repair_broken_allowlist_patchers_newline_in_quote_v4.py
${PY} scripts/_patch_repair_broken_allowlist_patchers_newline_in_quote_v4.py
