...
def main() -> int:
    ...
    # 1) Required markers (exact line matches via multiline regex search)
    ...
    #   - First occurrence anywhere in the doc
    ...
    # 4) Trace block label correctness (prevents regression)
    m_trace = re.search(
